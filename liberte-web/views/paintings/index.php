...
<section class="barclays">
    <h2>Barclays Bank and Candid Arts Trust</h2>
    <span class="container-lozenge image">
        <img src="/images/paintings_in-situ_la-legante.jpg" alt="La legante" />
    </span>
    <p>
        ONE Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque mattis vitae nisi eget eleifend. Phasellus tristique ut augue a consequat. Sed at dignissim augue, et tempor enim. Nunc viverra magna ut ex pretium, ac tincidunt ante tempus. Vestibulum non purus id augue fringilla varius vitae eu dolor. 
    </p>
    <p>
...
<section class="light">
    <h2>Light Gallery</h2>
    <span class="container-lozenge image">
        <img src="/images/paintings_in-situ_volcano.jpg" alt="Volcano" />
    </span>
    <p>
        TWO Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque mattis vitae nisi eget eleifend. Phasellus tristique ut augue a consequat. Sed at dignissim augue, et tempor enim. Nunc viverra magna ut ex pretium, ac tincidunt ante tempus. Vestibulum non purus id augue fringilla varius vitae eu dolor. 
    </p>
    <p>
        Proin lectus metus, facilisis nec mollis non, egestas convallis ante. Vestibulum nec nisi malesuada, sodales massa nec, dictum nisi. Sed id magna suscipit, vestibulum magna id, ultricies nisi. Etiam eu aliquet purus. Nullam eget augue interdum tortor semper finibus eget a urna. Suspendisse pretium justo non erat semper, nec vulputate velit egestas. Nam vitae sollicitudin tortor, id porta justo. Duis sagittis purus nec consectetur euismod.
    </p>
...
<section class="torbay">
    <h2>Torbay Hospital</h2>
    <span class="container-lozenge image">
        <img src="/images/paintings_in-situ_winter-mist.jpg" alt="Winter Mist" />
    </span>
    <p>
        THREE Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque mattis vitae nisi eget eleifend. Phasellus tristique ut augue a consequat. Sed at dignissim augue, et tempor enim. Nunc viverra magna ut ex pretium, ac tincidunt ante tempus. Vestibulum non purus id augue fringilla varius vitae eu dolor. 
    </p>
    <p>
        Proin lectus metus, facilisis nec mollis non, egestas convallis ante. Vestibulum nec nisi malesuada, sodales massa nec, dictum nisi. Sed id magna suscipit, vestibulum magna id, ultricies nisi. Etiam eu aliquet purus. Nullam eget augue interdum tortor semper finibus eget a urna. Suspendisse pretium justo non erat semper, nec vulputate velit egestas. Nam vitae sollicitudin tortor, id porta justo. Duis sagittis purus nec consectetur euismod.
    </p>
...
<!--
<div class="choice" style="margin-top:150px;">
    <h1>Artwork Exhibition</h1>
    <p>Liberte d’Expression has organised art exhibitions where the aim of these events is to give painters across the UK exposure for their art irrespective of their age, experience or artistic background whilst raising funding for really good causes.</p>
    ...
    <ul class="menu-gallery">
        <li>
            <h2>Barclays</h2>
            <a href="#barclays" class="container-lozenge">
                <img src="/images/paintings_in-situ_la-legante.jpg" alt="La legante" />
            </a>
        </li>
        <li>
            <h2>Light Gallery</h2>
            <a href="#light" class="container-lozenge">
                <img src="/images/paintings_in-situ_volcano.jpg" alt="Volcano" />
            </a>
        </li>
        <li>
            <h2>Torbay Hospital</h2>
            <a href="#torbay" class="container-lozenge">
                <img src="/images/paintings_in-situ_winter-mist.jpg" alt="Winter Mist" />
            </a>
        </li>
    </ul>
...
<div class="detail container-lozenge" style="margin-top:150px;">
