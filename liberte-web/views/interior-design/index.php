...
<section class="interior">
    ...
    <div class="description">
        <p><b>Concept rational 1:</b> For this project, I was inspired by one of Heston Blumentha’s main interests – rediscovering historical British gastronomy from Victorian, Tudor England to medieval times and ancient Rome. The idea came up whilst reading a number of articles and interviews about Heston Blumenthal. A particular sentence caught my attention <i>"... research into historic British gastronomy in a bid to recreate dishes inspired by the past."</i> I immediately thought this could be applied for the interior of the restaurant <i>"... research into historic British <b>styles</b> in a bid to recreate <b>interiors</b> inspired by the past."</i>  As the premises were a former pub circa 1550, it made sense to me to focus on the Tudor era.</p>
    </div>
    <ul class="gallery">
        <li>
        ...
        <li>
            <a href="/images/interior-design/interior/mood_board.jpg">
                <img src="/images/interior-design/interior/mood_board_thumb.jpg" alt="An interior-design residential feature" />
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="/images/interior-design/interior/dsc02232.jpg">
                <img src="/images/interior-design/interior/dsc02232_thumb.jpg" alt="An interior-design commercial feature" />
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="/images/interior-design/interior/restaurant_plan.jpg">
                <img src="/images/interior-design/interior/restaurant_plan_thumb.jpg" alt="An interior-design commercial feature" />
            </a>
        </li>
        <li>
            <a href="/images/interior-design/interior/scan0014_crop.jpg">
                <img src="/images/interior-design/interior/scan0014_crop_thumb.jpg" alt="An interior-design commercial feature" />
            </a>
        </li>
        <li>
